# ============================================================================
# login-service - cuenta de servicio dedicada
# ============================================================================
# Permisos:
#   - cloudsql.client                  conecta a Cloud SQL para refresh_tokens
#   - secretmanager.secretAccessor     lee db-password, jwt-secret, google-client-secret
# ============================================================================

. "$PSScriptRoot\..\infra\config.ps1"

$SA_NAME  = "login-service-sa"
...
if ($exists -eq $SA_EMAIL) {
  ...
  gcloud iam service-accounts create $SA_NAME `
    ...
    --description="OAuth Google + persistencia de refresh_token" `
